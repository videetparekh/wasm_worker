 ...
 */
export declare class DLContext {
 ...
 */
declare class GraphRuntime implements Disposable {
    module: Module;
...
export declare class Instance implements Disposable {
     ...
     * @param deviceId The device index.
     */
    cpu(deviceId?: number): DLContext;
    /**
     * Create a new webgpu {@link DLContext}
     * @param deviceId The device index.
     */
    webgpu(deviceId?: number): DLContext;
    /**
     ...
     */
    empty(shape: Array<number> | number, dtype?: string | DLDataType, ctx?: DLContext): NDArray;
    /**
     ...
     */
    createGraphRuntime(graphJson: string, lib: Module, ctx: DLContext): GraphRuntime;
    /**
